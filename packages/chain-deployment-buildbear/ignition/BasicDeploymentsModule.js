...
import HelloWorld from '../artifacts/contracts/BasicDeployments.sol/HelloWorld.json' assert {type: 'json'}

export const BasicDeploymentsModule = buildModule('BasicDeployments', (m) => {
