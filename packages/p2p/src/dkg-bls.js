//initial set up for each bootstrap node in the 
export const dkgInit = function(bls, threshold){
  const vvec = []
    const svec = []
 ...
 */
export const generateContribution = function (bls, ids, threshold) {
   ...
   * and `secretKeyContribution` which is an array of secret key pointers
   */
  export const generateZeroContribution = function (bls, ids, threshold) {
    // this id's verification vector
    const vvec = []
    // this id's secret keys
    const svec = []
